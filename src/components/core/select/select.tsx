      ...
      classNames={
        {
          ...
          singleValue: () =>
            "select-single-value capitalize flex flex-row max-w-full overflow-hidden text-ellipsis whitespace-nowrap text-gray-800 dark:text-gray-100 font-semibold",
          multiValue: () =>
            "flex rounded-lg mx-0.5 font-bold border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-800 dark:text-gray-100",
          multiValueLabel: () =>
            "text-xs ltr:pl-2 rtl:pr-2 py-1.5 flex items-center",
          multiValueRemove: () =>
            "flex items-center ltr:pr-2 ltr:pl-1 rtl:pr-1 rtl:pl-2",
          menu: () =>
            "bg-white dark:bg-gray-900 rounded-xl my-2 px-2 py-1 min-h-[50px] border ring-1 border-gray-100 ring-gray-100 dark:border-gray-700 dark:ring-gray-700 shadow-[0px_48px_64px_-16px_rgba(0,0,0,0.25)]",
          ...classNames,
